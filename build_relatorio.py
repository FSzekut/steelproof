...
figure, table, pre { grid-column: 1 / -1; justify-self: center; width: 100%; }
...
@media print {
  ...
  figure, table, pre { display: block; max-width: 100%; page-break-inside: avoid; }
  ...
  table { font-size: 9.1pt; margin: 11pt 0 14pt; }
